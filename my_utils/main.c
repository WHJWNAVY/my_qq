...
void main_main(void)
{
    ...
    CLI_REG_CMD(cat, 0, NULL, "Concatenate files and print on the standard output.");
    ...
    CLI_REG_CMD(man1, 0, NULL, "An interface to the on-line reference manuals.");
    CLI_REG_CMD(man2, 0, NULL, "An interface to the on-line reference manuals.");
    while(TRUE)
    {
